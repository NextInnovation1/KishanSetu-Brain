...
| Q6 | **iOS at pilot, or Android-first?** (VC self-evaluation, 16 Jul 2026) | **Recommendation from the evaluation: defer the iOS build past the pilot** — farmers are Android-only (₹8–12k devices, 05 §3.1), pilot buyers can be served Android + WhatsApp, and the solo-build parity cost (~30–40% of mobile effort) buys zero pilot learning. **This requires amending Golden Rule 1 (founder decision, in writing, per 00 change-control) — NOT decided here.** If ratified: parity rule suspends until post-pilot store launch; 07-PRD stays the single spec so iOS catch-up is a rendering task, not a redesign. Owner: **Alpesh** | PRD approval |
| Q7 | **Co-founder / founding ops-sales hire as a Phase-0 gate?** (VC self-evaluation, 16 Jul 2026) | The evaluation found the founder's own W1–W10 schedule requires being at the hub, in sales visits, and in the IDE simultaneously (16 R9); recommendation: make a committed co-founder or founding ops/sales hire a **gate to pilot go-live**, not a "standing agenda item". Owner: **Alpesh** | Phase-0 exit |
